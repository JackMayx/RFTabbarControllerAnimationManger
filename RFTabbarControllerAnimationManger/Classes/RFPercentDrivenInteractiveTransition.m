//
//  RFPercentDrivenInteractiveTransition.m
//  MyUtilDemo
//
...
@interface RFPercentDrivenInteractiveTransition()
...
@implementation RFPercentDrivenInteractiveTransition
...
- (void)gestureRecognizeDidUpdate:(UIScreenEdgePanGestureRecognizer *)gestureRecognizer{
    switch (gestureRecognizer.state) {
        ...
        case UIGestureRecognizerStateEnded:
            if ([self percentForGesture:gestureRecognizer] >= 0.2f){
